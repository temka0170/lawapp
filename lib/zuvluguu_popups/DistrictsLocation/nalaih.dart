...
class NALBox extends StatefulWidget {
  String title;

  NALBox({Key key, this.title}) : super(key: key);

  @override
  _NALBoxState createState() => _NALBoxState();
}

class _NALBoxState extends State<NALBox> {
