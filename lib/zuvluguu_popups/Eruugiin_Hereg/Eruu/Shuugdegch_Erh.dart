                  ...
                  child: GestureDetector(
                    ...
                    child: Padding(
                      ...
                      child: Container(
                        ...
                        child: Center(
                          child: Text("Гомдол, Хүсэлт гаргах"),
                        ),
                      ),
                    ),
                  ),
                    ...
                    child: Padding(
                      ...
                      child: Container(
                        decoration: BoxDecoration(
                            ...
                            borderRadius: BorderRadius.circular(8.0)),
                        child: Center(
                          child: Text("Мэдүүлэг өгөх, өгөхөөс татгалзах"),
                        ),
                      ),
                    ),
                  ),
                    ...
                    child: Padding(
                      ...
                      child: Container(
                        decoration: BoxDecoration(
                            ...
                            borderRadius: BorderRadius.circular(8.0)),
                        child: Center(
                          child: Text("Өмгөөлөгчтэй харилцах"),
                        ),
                      ),
                    ),
                  ),
                    ...
                    child: Padding(
                      ...
                      child: Container(
                        decoration: BoxDecoration(
                            ...
                            borderRadius: BorderRadius.circular(8.0)),
                        child: Center(
                          child: Text("Шүүх хуралдаанд оролцох"),
                        ),
                      ),
                    ),
                  ),
                    ...
                    child: Padding(
                      ...
                      child: Container(
                        decoration: BoxDecoration(
                            ...
                            borderRadius: BorderRadius.circular(8.0)),
                        child: Center(
                          child: Text("Ямар хэрэгт яллагдаж байгаагаа мэдэх"),
                        ),
                      ),
                    ),
                  ),
