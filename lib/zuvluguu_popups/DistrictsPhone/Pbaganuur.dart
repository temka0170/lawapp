...
class PBGBox extends StatefulWidget {
  String title;

  PBGBox({Key key, this.title}) : super(key: key);

  @override
  _PBGBoxState createState() => _PBGBoxState();
}

class _PBGBoxState extends State<PBGBox> {
